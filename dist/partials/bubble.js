...
templates['bubble.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<a class=\"bubble "
    + alias4(((helper = (helper = lookupProperty(helpers,"curView") || (depth0 != null ? lookupProperty(depth0,"curView") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"curView","hash":{},"data":data,"loc":{"start":{"line":1,"column":17},"end":{"line":1,"column":28}}}) : helper)))
